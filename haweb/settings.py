...
STATIC_ROOT = '/var/www/html/wmedia/haweb/stattic/'
...
SECRET_KEY = 'y4m37uf%-q@!vu8=3e*2$pa%ja!p4ntr7wq_py)z3g*)i4%82_'
...
ROOT_URLCONF = 'haweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'haweb.wsgi.application'
