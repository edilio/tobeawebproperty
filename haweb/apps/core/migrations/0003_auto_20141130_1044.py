...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('tenant_id', models.CharField(max_length=7, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('unit_id', models.CharField(max_length=7, null=True, blank=True)),
        ...
        migrations.AddField(
            model_name='unit',
            name='zip_code',
            field=models.ForeignKey(to='core.ZipCode'),
